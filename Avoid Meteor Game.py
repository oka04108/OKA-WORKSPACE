...
#배경 이미지 설정
background = pygame.image.load("C:\\Program Files\\Python Workspace\\Avoid Meteor Game\\background.png")

to_x = 0
to_y = 0

#우주선 캐릭터 이미지 설정
spaceship = pygame.image.load("C:\\Program Files\\Python Workspace\\Avoid Meteor Game\\spaceship.png")
...
#운석 캐릭터 이미지 설정
meteor = pygame.image.load("C:\\Program Files\\Python Workspace\\Avoid Meteor Game\\meteor.png")
